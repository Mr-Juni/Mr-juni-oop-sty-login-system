...
<?php require("partial/head.php"); ?>
	<h1 id='heading_sty'>REGISTRATION</h1>
	 ...
	 <div>
		...
		if (!empty($msgs)) {	
			if($msgs == "success") {
				echo "<div class='alert alert-warning error_div_sty' role='alert'><span class='form-error'>Registartion Successful <a href='login'>LOGIN</a></span></div>";
			}else {
				echo "<div class='alert alert-warning error_div_sty' role='alert'><span class='form-error'>".$msgs."</span></div>";
